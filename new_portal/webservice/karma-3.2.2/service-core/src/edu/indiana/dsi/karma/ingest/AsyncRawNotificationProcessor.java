...
# File:  AsyncRawNotificationProcessor.java
# Description:  Asynchoronous Raw Notification Processor
#
# -----------------------------------------------------------------
# 
*/
...
public class AsyncRawNotificationProcessor implements Runnable {
    ...
    public void run() {
        ...
        log.info("Async processor " + id + " started");
        ...
        log.info("Async processor " + id + " received stop signal");
        stopped = true;
    }
