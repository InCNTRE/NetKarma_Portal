...
# Description: Implements an object pool with database connections
#
# -----------------------------------------------------------------
# 
*/
...
public class DBConnectionPool implements ObjectPool<Connection>, Runnable {
    ...
    static class ExpirationManager implements Runnable {
        ...
        public void run() {
            log.info("ExpireMan thread started");
            stopped = false;
            int queueSize = 0;
            ...
            log.info("Connections received: " + totalReceived + " Connections Closed: " + totalClosed + " Nulls received: " + totalNull);
            log.info("Expiration manager stopped");
        }
    }
    ...
    /**
     * @see edu.indiana.dsi.karma.ingest.db.BaseDBIngesterImplementer.Pool#getEntry()
     */
    @Override
    ...
    /**
     * @see edu.indiana.dsi.karma.ingest.db.BaseDBIngesterImplementer.Pool#releaseEntry(java.lang.Object)
     */
    @Override
    ...
    public void run() {
        stopped = false;
        log.info("ConnPool control thread started");
        ...
        log.info("No outstanding busy connections");
        ...
        log.info("All open connections on expire row");
        expireManager.stop();
        log.info("Connections Created: " + totalCreated +  " Connections Discarded: " + totalDiscarded + " Null sent to expire row: " + totalNull);
        log.info("ConnPool thread stopped");
    }
