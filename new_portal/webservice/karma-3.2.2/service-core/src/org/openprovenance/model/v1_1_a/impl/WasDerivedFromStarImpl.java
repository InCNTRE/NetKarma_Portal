 ...
 */
public class WasDerivedFromStarImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openprovenance.model.v1_1_a.WasDerivedFromStar
{
    
    public WasDerivedFromStarImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final org.apache.xmlbeans.QNameSet ANNOTATION$7 = org.apache.xmlbeans.QNameSet.forArray( new javax.xml.namespace.QName[] { 
     ...
     */
    public org.openprovenance.model.v1_1_a.ArtifactRef getEffect()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openprovenance.model.v1_1_a.ArtifactRef target = null;
            target = (org.openprovenance.model.v1_1_a.ArtifactRef)get_store().find_element_user(EFFECT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setEffect(org.openprovenance.model.v1_1_a.ArtifactRef effect)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openprovenance.model.v1_1_a.ArtifactRef)get_store().add_element_user(EFFECT$0);
            }
            target.set(effect);
        }
    }
     ...
     */
    public org.openprovenance.model.v1_1_a.ArtifactRef addNewEffect()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public org.openprovenance.model.v1_1_a.ArtifactRef getCause()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openprovenance.model.v1_1_a.ArtifactRef target = null;
            target = (org.openprovenance.model.v1_1_a.ArtifactRef)get_store().find_element_user(CAUSE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCause(org.openprovenance.model.v1_1_a.ArtifactRef cause)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openprovenance.model.v1_1_a.ArtifactRef)get_store().add_element_user(CAUSE$2);
            }
            target.set(cause);
        }
    }
    ...
    public org.openprovenance.model.v1_1_a.EmbeddedAnnotation[] getAnnotationArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(ANNOTATION$7, targetList);
    ...
    public org.openprovenance.model.v1_1_a.EmbeddedAnnotation getAnnotationArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.openprovenance.model.v1_1_a.EmbeddedAnnotation)get_store().find_element_user(ANNOTATION$7, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfAnnotationArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ANNOTATION$7);
        }
    }
    ...
    public void setAnnotationArray(org.openprovenance.model.v1_1_a.EmbeddedAnnotation[] annotationArray)
    {
        ...
        {
            check_orphaned();
            arraySetterHelper(annotationArray, ANNOTATION$6, ANNOTATION$7);
        }
    }
    ...
    public org.openprovenance.model.v1_1_a.EmbeddedAnnotation insertNewAnnotation(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openprovenance.model.v1_1_a.EmbeddedAnnotation target = null;
            target = (org.openprovenance.model.v1_1_a.EmbeddedAnnotation)get_store().insert_element_user(ANNOTATION$7, ANNOTATION$6, i);
            return target;
        }
    }
    ...
    public org.openprovenance.model.v1_1_a.EmbeddedAnnotation addNewAnnotation()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openprovenance.model.v1_1_a.EmbeddedAnnotation target = null;
            target = (org.openprovenance.model.v1_1_a.EmbeddedAnnotation)get_store().add_element_user(ANNOTATION$6);
            return target;
        }
    }
    ...
    public void removeAnnotation(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ANNOTATION$7, i);
        }
    }
