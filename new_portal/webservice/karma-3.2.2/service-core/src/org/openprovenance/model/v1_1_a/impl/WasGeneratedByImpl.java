 ...
 */
public class WasGeneratedByImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openprovenance.model.v1_1_a.WasGeneratedBy
{
    
    public WasGeneratedByImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.openprovenance.model.v1_1_a.ProcessRef getCause()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openprovenance.model.v1_1_a.ProcessRef)get_store().find_element_user(CAUSE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setCause(org.openprovenance.model.v1_1_a.ProcessRef cause)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openprovenance.model.v1_1_a.ProcessRef)get_store().add_element_user(CAUSE$4);
            }
            target.set(cause);
        }
    }
